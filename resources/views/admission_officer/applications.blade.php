                      ...
                      >
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <button class="btn btn-link btn-info btn-sm" title="View"><i class="fa fa-eye fa-lg"></i></button>
                              <button class="btn btn-link btn-primary btn-sm" title="Edit"><i class="fa fa-edit fa-lg"></i></button>
                              <button class="btn btn-link btn-danger btn-sm" title="Delete"><i class="fa fa-trash fa-lg"></i></button>
                          ...
                          <tr>
                            ...
                            <td><span class="badge bg-success">Success</span></td>
                            <td>
                              <button class="btn btn-link btn-info btn-lg" title="View"><i class="fa fa-eye fa-lg"></i></button>
                              <button class="btn btn-link btn-primary btn-sm" title="Edit"><i class="fa fa-edit fa-lg"></i></button>
                              <button class="btn btn-link btn-danger btn-sm" title="Delete"><i class="fa fa-trash fa-lg"></i></button>
